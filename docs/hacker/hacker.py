...
class App:
    ...
    def __init__(self):
        ...
        x, y = 20, 20
        dy = 120
        Icon(self, "icons/address-book.png", pos=(x, y))
        y += dy
        Icon(self, "icons/device-camera.png", pos=(x, y))
        y += dy
        Icon(self, "icons/device-computer.png", pos=(x, y))
        y += dy
        Icon(self, "icons/device-drive.png", pos=(x, y))
        y += dy
...
class Window(Node):
    ...
    def draw(self, pos=(0, 0)):
        ...
        pygame.draw.rect(
            App.screen, self.titlebar_color, (*self.rect.topleft, self.rect.width, 40)
        )
